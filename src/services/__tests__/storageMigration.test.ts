...
describe('Storage Migration', () => {
  ...
  describe('detectOldData', () => {
    ...
    it('should detect old streamSources data', async () => {
      ...
      localStorage.setItem('wizju-stream-sources', JSON.stringify(oldData))
    ...
    it('should detect old mediaItems data', async () => {
      ...
      localStorage.setItem('wizju-media-items', JSON.stringify(oldData))
    ...
    it('should detect data even with invalid JSON', async () => {
      localStorage.setItem('wizju-stream-sources', 'invalid-json')
